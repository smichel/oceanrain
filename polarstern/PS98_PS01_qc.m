...
data=load('joint_PSDISDRO_PS98-PS01_colloc_cont_ww_na.txt');

%tocheck=load('joint_PSDISDRO_PS98-PS01_phase_algo_prelim_tocheck.txt');

data_name='joint_PSDISDRO_PS98-PS01_colloc_cont_ww_na.txt';
PSD_na_name='joint_PSDISDRO_PS98-PS01_psd_na.txt';
PSD_num_na_name='joint_PSDISDRO_PS98-PS01_psd_num_na.txt';
PSD_na=load(PSD_na_name);
PSD_num_na=load(PSD_num_na_name);
rain_snow=load('rainsnow_data_PS98-PS01.txt');
rain=load('rain_minute_psd_num_PS98-PS01.dat');

snow_PSD_num_na=load('snow_minute_psd_num_PS98-PS01.dat');
snow_PSD_na=load('snow_minute_psd_dbz_PS98-PS01.dat');

rain_PSD_num_na=load('rain_minute_psd_num_PS98-PS01.dat');
rain_PSD_na=load('rain_minute_psd_dbz_PS98-PS01.dat');
...
pos1=find(data(:,6)==1.460912880000000e+09);

data(pos1,10)=data(pos1-1,10)/2+data(pos1+1,10)/2;
...
changed=[changed,{[data(pos1,6) 10]}];
