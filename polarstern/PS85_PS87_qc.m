...
for i=1:length(resc_snow)
    ...
    data(loc_snow(i),31)=0;
    data(loc_snow(i),32)=0;
    data(loc_snow(i),33)=1;
    data(loc_snow(i),34)=2;
    if tocheck(pos_snow(i),29) ==0
        data(loc_snow(i),35) = 12;
    elseif tocheck(pos_snow(i),29)<=0.09
        data(loc_snow(i),35) = 13;
    elseif tocheck(pos_snow(i),29)>0.09 & tocheck(pos_snow(i),29)<=0.99
        data(loc_snow(i),35) = 14;
    elseif tocheck(pos_snow(i),29)>0.99 & tocheck(pos_snow(i),29)<=10
        data(loc_snow(i),35) = 15;
    elseif tocheck(pos_snow(i),29)>10   & tocheck(pos_snow(i),29)<=50
        data(loc_snow(i),35) = 16;
    elseif tocheck(pos_snow(i),29)>50
