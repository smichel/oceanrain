...
data=load('joint_PSDISDRO_PS81-PS83_colloc_cont_ww_na.txt');
data_name='joint_PSDISDRO_PS81-PS83_colloc_cont_ww_na.txt';



data(63951:63960,7)=linspace(data(63951,7),data(63960,7),length(data(63951:63960,7)));
data(751513:751528,7)=linspace(data(751513,7),data(751528,7),length(data(751513:751528,7)));
data(751513:751528,8)=linspace(data(751513,8),data(751528,8),length(data(751513:751528,8)));
k=1;
for i=[63951:63960 751513:751528]
    if i < 100000
        changed{k}=[data(i,6) 7];
        k=k+1;
    else 
        changed{k}=[data(i,6) 7 8];
        k=k+1;
    end
end
k=1;
...
snow_changed=snow_susp;
snow_susp_dd=data(snow_changed,2);
snow_susp_mm=data(snow_changed,3);


PSD_na_name='joint_PSDISDRO_PS81-PS83_psd_na.txt';
PSD_num_na_name='joint_PSDISDRO_PS81-PS83_psd_num_na.txt';
PSD_na=load(PSD_na_name);
PSD_num_na=load(PSD_num_na_name);
rain_snow=load('rainsnow_data_PS81-PS83.txt');
rain=load('rain_minute_psd_num_PS81-PS83.dat');

snow_PSD_num_na=load('snow_minute_psd_num_PS81-PS83.dat');
snow_PSD_na=load('snow_minute_psd_dbz_PS81-PS83.dat');
...
[snow_lia_na,snow_loc_na]=ismember(data(snow_changed,6),PSD_na(:,6));
