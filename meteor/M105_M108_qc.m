...
data=load('joint_METEORDISDRO_M105-M108_colloc_cont_ww_na.txt');
data_name='joint_METEORDISDRO_M105-M108_colloc_cont_ww_na.txt';

data_name='joint_METEORDISDRO_M105-M108_colloc_cont_ww_na.txt';
PSD_na_name='joint_METEORDISDRO_M105-M108_psd_na.txt';
PSD_num_na_name='joint_METEORDISDRO_M105-M108_psd_num_na.txt';
PSD_na=load(PSD_na_name);
PSD_num_na=load(PSD_num_na_name);
rain_snow=load('rainsnow_data_M105-M108.txt');
rain=load('rain_minute_psd_num_M105-M108.dat');

snow_PSD_num_na=load('snow_minute_psd_num_M105-M108.dat');
snow_PSD_na=load('snow_minute_psd_dbz_M105-M108.dat');

rain_PSD_num_na=load('rain_minute_psd_num_M105-M108.dat');
rain_PSD_na=load('rain_minute_psd_dbz_M105-M108.dat');
