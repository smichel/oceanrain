...
% OUTPUT:
%
% s:     turbulent flux in W/m^2
% qh:    sensible heat flux in W/m^2
% qe:    latent heat flux in W/m^2
% evap:  evaporation in mm/h
...
cd = (C_von/log(zu/zo10))^2;                    % transfer coefficients 
