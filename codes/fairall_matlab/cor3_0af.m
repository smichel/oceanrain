...
if didread~=1;
   %x=load('c:\My Documents\matlabstf\bulkalg\test2_5b.txt');%read file with half-hour average data; set your local directory 
    x=load('/scratch/uni/u237/users/smichel/oceanrain/codes/fairall#matlab/test3_0.txt');%read file with 1hr-average data; set your local directory 
...
if prtit==1;
  	...
  	save 'c:\data\cwf\matlabstf\cwf\bulkalg\outs\tst3_0af_out' out
	e= 'c:\data\cwf\matlabstf\cwf\bulkalg\outs\tst3_0af_out.txt' ;
