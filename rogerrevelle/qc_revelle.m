...
data=load('joint_rogerrevelle_disdro_2016M08-2016M09_colloc_cont_ww_na.txt');
data_name='joint_rogerrevelle_disdro_2016M08-2016M09_colloc_cont_ww_na.txt';
PSD_na_name='joint_rogerrevelle_disdro_2016M08-2016M09_psd_cont_na.txt';
PSD_num_na_name='joint_rogerrevelle_disdro_2016M08-2016M09_psd_num_na.txt';
PSD_na=load(PSD_na_name);
PSD_num_na=load(PSD_num_na_name);
rain_snow=load('rainsnow_data_2016M08-2016M09.txt');
rain=load('rain_minute_psd_num_2016M08-2016M09.dat');
