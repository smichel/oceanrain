...
data=load('joint_sonne_disdro_2012M09-2012M10_colloc_cont_ww_na.txt');
data_name='joint_sonne_disdro_2012M09-2012M10_colloc_cont_ww_na.txt';
c_data=load('joint_sonne_disdro_2012M09-2012M10_colloc_cont_ww_na_ancillary_checked.txt');
T=data(:,10);

k=1;
for i=1:length(data)
    if (data(i,23)<5) & (data(i,12)>50)
        data(i,12)=-99.9;
        data(i,23)=-99.9;
        changed{k}=[data(i,6) 12 23];
        k=k+1;
    elseif (data(i,23)<5) & (data(i,12)<50)
        data(i,23)=-99.9;
...
PSD_na_name='joint_sonne_disdro_2012M09-2012M10_psd_na.txt';
PSD_num_na_name='joint_sonne_disdro_2012M09-2012M10_psd_num_na.txt';
PSD_na=load(PSD_na_name);
PSD_num_na=load(PSD_num_na_name);

rain_snow=load('rainsnow_data_2012M09-2012M10.txt');
rain=load('rain_minute_psd_num_2012M09-2012M10.dat');

snow_PSD_num_na=load('snow_minute_psd_num_2012M09-2012M10.dat');
snow_PSD_na=load('snow_minute_psd_dbz_2012M09-2012M10.dat');

rain_PSD_na=load('rain_minute_psd_num_2012M09-2012M10.dat');
rain_PSD_num_na=load('rain_minute_psd_dbz_2012M09-2012M10.dat');
...
if safe
    ...
    parameter_outfile='joint_sonne_disdro_2012M09-2012M10_changed_parameters.txt';
