...
data_name=('joint_investigator_disdro_2016V01-2016V02_colloc_cont_ww_na.txt');
...
PSD_na_name='joint_investigator_disdro_2016V01-2016V02_psd_na.txt';
PSD_num_na_name='joint_investigator_disdro_2016V01-2016V02_psd_num_na.txt';
PSD_na=load(PSD_na_name);
PSD_num_na=load(PSD_num_na_name);
rain_snow=load('rainsnow_data_2016V01-2016V02.txt');
rain=load('rain_minute_psd_num_2016V01-2016V02.dat');

snow_PSD_num_na=load('snow_minute_psd_num_2016V01-2016V02.dat');
snow_PSD_na=load('snow_minute_psd_dbz_2016V01-2016V02.dat');
...
if safe
    ...
    parameter_outfile='joint_investigator_disdro_2016V01-2016V02_changed_parameters.txt';
