...
data_name=('joint_investigator_disdro_2016V02-2016V03_colloc_cont_ww_na.txt');
...
for i=2:size(data,1)-1
    ...
    if (data(i,23)<5) & (data(i,23)>-5)
        data(i,23)= -99.99;
        changed{j}=[data(i,6) 23];
        j=j+1;
    end
    if (data(i,10)>=45)
...
PSD_na_name='joint_investigator_disdro_2016V02-2016V03_psd_na.txt';
PSD_num_na_name='joint_investigator_disdro_2016V02-2016V03_psd_num_na.txt';
PSD_na=load(PSD_na_name);
PSD_num_na=load(PSD_num_na_name);
rain_snow=load('rainsnow_data_2016V02-2016V03.txt');
rain=load('rain_minute_psd_num_2016V02-2016V03.dat');

snow_PSD_num_na=load('snow_minute_psd_num_2016V02-2016V03.dat');
snow_PSD_na=load('snow_minute_psd_dbz_2016V02-2016V03.dat');
...
if safe
    ...
    parameter_outfile='joint_investigator_disdro_2016V02-2016V03_changed_parameters.txt';
